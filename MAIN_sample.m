...
T_sim = [0.01,0.1,1]; % vector of period of interest in range 0.01-5s
...
x_coordinates = randi(200,100,1); % Should be [n x 1]
y_coordinates = randi(200,100,1); % Should be [n x 1]
